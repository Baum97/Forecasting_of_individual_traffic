...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}l || X@{}}
    ...
    \cmidrule{1-1}
    \addlinespace
    FF2 & Anforderungn die sich ergeben, sind u.a. Anspruch an Qualität, Relevanz und Verwendbarkeit der Daten. \\
    \addlinespace
     FF2.1 &  \\
    \addlinespace
     FF2.2 &  \\
