...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}l || X@{}}
    ...
    \cmidrule{1-1}
    \addlinespace
    FF2 & Anforderungen die sich ergeben, sind u.a. Anspruch an Qualität, Relevanz und Verwendbarkeit der Daten. \\
    \addlinespace
     FF2.1 & Aufbereitung wirkt sich im Optimalfall nicht auf die Nutzbarkeit der Daten aus; Fehlerhafte Daten können optional für Robustheit beibehalten werden. In der Theorie hat die Anonymisierung bei korrekt optimierten Algorithmen -- bspw. durch Verschlüsselung mit CKKS (Cheon-Kim-Kim-Song), Fully Homomorphic Encryption -- einen geringen Einfluss auf die Nutzbarkeit der Daten.  \\
    \addlinespace
