...
\begin{enumerate}
    \item Wie zuverlässig lässt sich das individuelle Mobilitätsverhalten
          einzelner Fahrzeuge über einen Horizont von bis zu sieben Tagen
          vorhersagen?
    \begin{enumerate}
        \item Wie unterscheiden sich verschiedene Verfahren des maschinellen
              Lernens hinsichtlich ihrer Vorhersagegenauigkeit?
        \begin{enumerate}
            \item Welchen Einfluss hat die Datenqualität bzw.\ -quelle auf die
                  Prognosegüte -- getrennt vom Einfluss des gewählten
                  Algorithmus?
        \end{enumerate}
        \item Welche Merkmale beeinflussen das individuelle Mobilitätsverhalten
              am stärksten?
    \end{enumerate}
    \item Welche Anforderungen an die Datengrundlage ergeben sich daraus, und
          wie lässt sich ihre Qualität bewerten?
    \begin{enumerate}
        \item Wie wirken sich Aufbereitung und eine aus Datenschutzgründen
...
\todo{nochmal überschauen/bearbeiten*}
