...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}l || X@{}}
    ...
    \addlinespace
     FF1.1.1 & Welchen Einfluss hat die Datenqualität bzw.\ -quelle auf
    ...
    \cmidrule{1-1}
    \addlinespace
    FF2 & Welche Anforderungen an die Datengrundlage ergeben sich daraus, und wie
          lässt sich ihre Qualität bewerten? \\
    \addlinespace
     FF2.1 & Wie wirken sich Aufbereitung und eine aus Datenschutzgründen
          notwendige Anonymisierung auf die Nutzbarkeit der Daten aus? \\
    \bottomrule
  \end{tabularx}
\end{table}
