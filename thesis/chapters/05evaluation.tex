...
\begin{table}[H]
    \centering
    \caption{In-distribution (in eigener Menge -- Datenquelle, in diesem Fall) Gütemaße des Driving-Classifiers je Datenquelle. RandomForest, LightGBM und tab. LSTM-Variante nutzen Merkmalssatz; seq. Variante sieht Rohfenster. \enquote{n.\,z.} = nicht als Trainingsquelle zugelassen, da Quelle Mindestkriterium von 100 Fahrzeugwochen verfehlt (\cref{sec:modellauswahl}). \textbf{Fett} markiert je Datenquelle und Metrik den besten der vier Algorithmen (über die Teiltabellen hinweg; beim Brier-Score ist der niedrigste Wert am besten). Bei \enquote{n.\,z.}-Quellen konkurrieren nur RandomForest und LightGBM.}
    ...
    \begin{subtable}{\textwidth}
        ...
        \begin{tabular}{lcccccc}
            ...
            \midrule
            emobpy          & 0,096 & \textbf{0,697} & 0,318 & 0,798 & 0,268 & \textbf{0,169} \\
            real\_world\_ev & 0,023 & \textbf{0,982} & \textbf{0,680} & \textbf{0,895} & \textbf{0,630} & \textbf{0,020} \\
            ved             & 0,048 & \textbf{0,881} & 0,075 & \textbf{0,725} & \textbf{0,089} & \textbf{0,089} \\
            routine         & 0,264 & \textbf{0,903} & \textbf{0,826} & \textbf{0,961} & \textbf{0,887} & \textbf{0,073} \\
    ...
    \begin{subtable}{\textwidth}
        ...
        \begin{tabular}{lcccccc}
            ...
            ved             & 0,048 & 0,846 & \textbf{0,092} & 0,687 & 0,077 & 0,110 \\
            routine         & 0,264 & 0,880 & 0,783 & 0,954 & 0,873 & 0,090 \\
            yjmob100k       & 0,382 & \textbf{0,726} & 0,676 & \textbf{0,807} & 0,699 & \textbf{0,180} \\
            \bottomrule
        \end{tabular}
    \end{subtable}
    ...
    \begin{subtable}{\textwidth}
        ...
        \begin{tabular}{lcccccc}
            ...
            \textbf{Datenquelle} & \textbf{Aktiv-Rate} & Acc. & F1 & ROC & PR & Brier \\
            \midrule
            emobpy          & 0,096 & 0,670 & \textbf{0,324} & \textbf{0,820} & \textbf{0,289} & 0,188 \\
            real\_world\_ev & 0,023 & \multicolumn{5}{c}{n.\,z.} \\
            ved             & 0,048 & \multicolumn{5}{c}{n.\,z.} \\
            routine         & 0,264 & \multicolumn{5}{c}{n.\,z.} \\
            yjmob100k       & 0,382 & 0,717 & 0,654 & 0,781 & 0,662 & 0,190 \\
            \bottomrule
        \end{tabular}
    \end{subtable}
\end{table}
