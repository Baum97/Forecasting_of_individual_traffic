...
\begin{figure}[H]
  ...
  \caption{Trainingskurven der LGBM-Varianten auf den zulässigen Datenquellen. Die gestrichelte Linie markiert den Haltepunkte, der durch Early Stopping Overfitting verhindert.}
...
\begin{figure}[H]
  ...
  \caption{Trainingskurven der LSTM-Varianten (tabellarisch und sequenziell) auf den zulässigen Datenquellen. Die gestrichelte Linie markiert den Haltepunkte, der durch Early Stopping Overfitting verhindert.}
