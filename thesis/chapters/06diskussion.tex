...
\subsection*{Daten}
\begin{itemize}
    \item \textbf{Heterogene Aktivitätsdefinition:} In den Datensätzen wird die Aktivität \textit{driving} jeweils unterschiedlich definiert (siehe \Cref{sec:herausforderungen}, uneinheitliche Aktivitätssignale). Dadurch ensteht eine inhärente Heterogenität, die die Vergleichbarkeit der Ergebnisse durch potentielle Labelinkonsistenzen einschränkt.
...
\begin{itemize}
    ...
    \item \textbf{Wahrscheinlichkeiten:} Kalibrierung (Brier-Score) und P10/P90-Quantile sorgen für eine bessere Interpretierbarkeit und liefern ein Band, statt eines Punktwertes.
...
\begin{itemize}
    ...
    \item \textbf{Schwelle für Sequenzmodelle:} Die Ergebnisse zeigen, dass Sequenzmodelle nur bei einer ausreichenden Anzahl an Fahrzeugwochen sinnvoll sind. Unterhalb dieser Schwelle liefern sie keine verlässlichen Ergebnisse.
