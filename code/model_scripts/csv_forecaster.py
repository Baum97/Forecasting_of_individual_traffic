"""Backward-Compat-Shim — Inhalte sind jetzt in randomforest_forecaster.py.
...
Neuer Code sollte direkt aus model_scripts.randomforest_forecaster
importieren.
"""
from model_scripts.randomforest_forecaster import (  # noqa: F401
    Config,
    FEATURE_COLS,
    Forecaster,
